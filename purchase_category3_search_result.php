...
<html lang="ko">
   ...
   <body class="main-layout footer_to90 project_page">
      ...
      <div class="purchase_main">
        ...
        <?php
          $sql2 = mq("select * from board where $catagory like '%$search_con%' and category = '3' and ps = '2' order by idx desc");
    ...
    <div id="search_box2" class="search_box">
      <form action="purchase_category3_search_result.php" method="get">
