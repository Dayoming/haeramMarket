   ...
   <body class="main-layout footer_to90 project_page">
      ...
      <div id="project" class="project" style="padding:0;">
         <div class="container">
            ...
            <ul class="cards">
            <?php
          $sql2 = mq("select * from board where $catagory like '%$search_con%' and category = '4' and ps = '1' order by idx desc");
        ...
        ?>
         ...
         <?php } ?>
            ...
            <div id="search_box2" class="search_box">
               <form action="sale_category4_search_result.php" method="get">
